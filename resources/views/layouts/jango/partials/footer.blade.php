            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="c-container c-first">
                        ...
                        <ul class="c-links">
                            ...
                            <li>
                                <a href="{{$value->getSlugEasier()}}">{{$value->title}}</a>
                            </li>
                            @endforeach
                        </ul>
                        @endif
                ...
                <div class="col-md-3">
                    <div class="c-container">
                        @if(isset($product))
                        <div class="c-content-title-1">
                            <h3 class="c-font-uppercase c-font-bold c-font-white">Similar products</h3>
                            <div class="c-line-left hide"></div>
                        </div>
                        <?php
                            $similarproducts = $product->getSimilar(9);
                        ?>
                        @if(!empty($similarproducts))
                        <ul class="c-works">
                            @foreach($similarproducts as $value)
                            <li class="c-first">
                                <a href="{{ $value->getSlug() }}">
                                    <img src="{{ ProductHelper::imagePath($value, 's') }}" alt="" class="img-responsive" />
                                </a>
                            </li>
                            @endforeach
                            </ul>
                        @else
                        There are no other similar products
                        @endif
                        @endif
