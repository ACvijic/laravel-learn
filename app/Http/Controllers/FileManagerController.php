...
{
    /*
     * only authenticated users have access to these actions
     */
    ...
    /*
     * method for visual rendering
     */
    public function popUp() {
        return view('elFinder.popUp');
    }
    ...
    public function connector() {
        ...
        // elFinder autoload
        require resource_path() . '/elfinder/php/autoload.php';
        // ===============================================
        ...
        $opts = array(
                ...
                'roots' => array(
                            array(
                                    ...
                                    'path'          => base_path('public/elfinder-uploads'),                 // path to files (REQUIRED)
                                    'URL'           => '/elfinder-uploads', // URL to files (REQUIRED)
                                    "tmbURL"        => "/elfinder-uploads/.tmb/", // (String) Thumbnails folder URL
